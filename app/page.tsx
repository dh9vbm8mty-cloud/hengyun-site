    ...
    <div className="min-h-screen flex flex-col">
      ...
      <header className="sticky top-0 z-50 bg-white/80 backdrop-blur border-b">
        <div className="mx-auto max-w-6xl px-6 py-4 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-5 text-sm">
            <a className="text-gray-700 hover:text-black" href="#amps">AMPS</a>
            <a className="text-gray-700 hover:text-black" href="#steps">STEPS</a>
            <a className="text-gray-700 hover:text-black" href="#demo">Demo</a>
            <a className="text-gray-700 hover:text-black" href="#contact">Contact</a>
          </nav>
        </div>
      </header>
      ...
      <main className="flex-1">
        ...
        <section className="mx-auto max-w-6xl px-6 py-16">
          <div className="max-w-3xl">
            ...
            <div className="mt-10 flex gap-3 flex-wrap">
              <a href="#demo" className="rounded-md border px-4 py-2 text-sm hover:bg-gray-50">
                Demo / Partners
              </a>
              <a href="#contact" className="rounded-md border px-4 py-2 text-sm hover:bg-gray-50">
                Contact
              </a>
            </div>
        ...
        <section id="demo" className="mx-auto max-w-6xl px-6 py-12 border-t scroll-mt-24">
          <div className="max-w-3xl">
            ...
            <p className="mt-3 text-gray-600">
              We are open to collaboration for urban pilot deployments and demonstration sites. Engagement typically
              includes site evaluation, deployment planning, and measurement-oriented operation.
            </p>
        ...
        <section id="contact" className="mx-auto max-w-6xl px-6 py-12 border-t scroll-mt-24">
          <div className="max-w-3xl">
            ...
            <p className="mt-3 text-gray-600">For partnership inquiries, please email:</p>

            <div className="mt-4 rounded-lg border p-4">
              <div className="text-sm text-gray-500">Email</div>
              <div className="mt-1 font-medium">founder@hengyun-tech.com</div>
            </div>

            <p className="mt-6 text-xs text-gray-500">
              This site presents a public-safe overview. Detailed technical specifications and validation data are
      ...
      <footer className="border-t">
        <div className="mx-auto max-w-6xl px-6 py-10">
          ...
          <div className="mt-8 text-xs text-gray-500">© {new Date().getFullYear()} HENGYUN Technology</div>
        </div>
      </footer>
    </div>
  );
